...
import { FORM_EMAIL_INITIAL_VALUES } from 'components/account/company/company-edit/form-email/form-email.constants';
import { FormEmailValues } from 'components/account/company/company-edit/form-email/form-email.types';
...
export const useFormEmail: UseFormBase<FormEmailValues> = (
  ...
  const validation: ValidationRules<FormEmailValues> = {
    email: {
      required: {
        value: true,
        message: t('account:company.form.email.errors.empty'),
      },
    },
  };
