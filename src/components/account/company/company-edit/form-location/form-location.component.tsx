...
import { Button, Map, mapIcon, MapDragendEvent } from 'ui';
import { DEFAULT_CENTER } from 'components/account/company/company-edit/form-location/form-location.constants';
import { Point } from 'types/common/geo';
import { Locale } from 'types/common/locales';
import { PreviewLocation } from 'components/account/company/company-edit/preview-location/preview-location.component';
