...
import { FORM_SOCIAL_LINK_INITIAL_VALUES } from 'components/account/company/company-edit/form-social-link/form-social-link.constants';
...
export const useFormSocialLink: UseFormBase<FormSocialLinkValues> = (
  ...
  const validation: ValidationRules<FormSocialLinkValues> = {
    url: {
      required: {
        value: true,
        message: t('account:company.form.socialLinks.url.errors.empty'),
      },
    },
  };
