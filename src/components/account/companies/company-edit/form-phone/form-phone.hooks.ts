...
import { FORM_PHONE_INITIAL_VALUES } from 'components/account/company/company-edit/form-phone/form-phone.constants';
import { FormPhoneValues } from 'components/account/company/company-edit/form-phone/form-phone.types';
...
export const useFormPhone: UseFormBase<FormPhoneValues> = (
  ...
  const validation: ValidationRules<FormPhoneValues> = {
    phone: {
      required: {
        value: true,
        message: t('account:company.form.phone.errors.empty'),
      },
    },
  };
