...
import { AccountNavigation, ProviderEditLocation } from 'components/account';
...
export const getServerSideProps: GetServerSideProps<Props> = async ({
  ...
  const { id } = getRouteParams(routes.account.providers.one.location, params);
...
const ProviderEditLocationPage: NextPage<
        ...
        <PageLayout>
          <Breadcrumbs
            items={[
              ...
              {
                label: t('account:providers.location.title'),
              },
            ]}
          />

          <AccountLayout>
            <ProviderEditLocation />
          </AccountLayout>
        </PageLayout>
      </MainLayout>
    </>
...
export default ProviderEditLocationPage;
