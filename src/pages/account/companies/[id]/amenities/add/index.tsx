...
import { CompanyEditAmenitiesAdd } from 'components/account';

const CompanyEditAmenitiesAddPage: NextPage = () => {
...
export default CompanyEditAmenitiesAddPage;
